...
ArrayAdapter<String> listAdapter = new CustomListAdapter(this, R.layout.item_listview_expand);
for (int i=0; i<20;i++)
...
if (convertView == null) {
	convertView = getLayoutInflater().inflate(R.layout.item_listview_expand, null);
}
