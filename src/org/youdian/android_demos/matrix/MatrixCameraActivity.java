 ...
 * 
 */
public class MatrixCameraActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_matrix_matrixcamera);
		// camera
		camera = new Camera();
		// initViews
		// rotate
	...
	private void refreshImage() {
		...
		matrix.preTranslate(225 >> 1, 225 >> 1);
		...
		try {
			...
			newBit = Bitmap.createBitmap(tmpBit, 0, 0, 225, 225, matrix, true);
