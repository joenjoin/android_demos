...
public class CubeAnimation extends Animation {
	...
	public CubeAnimation(Context context, AttributeSet attrs) {
		...
		if (value.type == TypedValue.TYPE_FLOAT) {// FLOAT
													// ���͵ģ���������������ˣ���Ϊ�±ߵ�resolveData
													// �����ò���TypedValue��û������
	...
	public void initialize(int width, int height, int parentWidth,
		...
		if (this.mFromXType != TypedValue.TYPE_FLOAT) {// ����Float���ʹ���̶�ֵ�����Ѿ������������ٽ���
														// ��ͬ
			this.mFromX = resolveData(this.mFromXType, this.mFromXdata, width,
					parentWidth);
		}
		if (mToXType != TypedValue.TYPE_FLOAT) {
			this.mToX = resolveData(this.mToXType, this.mToXData, width,
					parentWidth);
		}
	...
	float resolveData(int type, int data, int size, int psize) {
		...
		if (type == TypedValue.TYPE_FRACTION) {
			...
			value = TypedValue.complexToDimension(data,
	...
	protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		matrix.postTranslate(mFromX + (mToX - mFromX) * interpolatedTime,
				this.mAxisY);
