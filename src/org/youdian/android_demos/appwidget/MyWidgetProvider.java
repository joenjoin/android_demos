...
public class MyWidgetProvider extends AppWidgetProvider {
	...
	private static final String ITEM_CLICKED_ACTION="org.youdian.android_demos.appwidget.simpleitem";
	@SuppressLint("NewApi")
	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		for(int i=0;i<N;i++){
			RemoteViews rv=new RemoteViews(context.getPackageName(), R.layout.appwidget_simple);
			...
			PendingIntent itemPendingIntent=PendingIntent.getBroadcast(context, 0, itemClickIntent, PendingIntent.FLAG_UPDATE_CURRENT);
