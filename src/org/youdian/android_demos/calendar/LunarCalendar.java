...
public class LunarCalendar {
	...
	public static void main(String[] args) { 
		// 调用农历日期转换阳历日期方法 
		System.out.println(ChineseCalendar.sCalendarLundarToSolar(Integer.parseInt(args[0]),Integer.parseInt(args[1]),Integer.parseInt(args[2]))); 
		} 
		} 
		// 自定义日历类 
	class ChineseCalendar { 
		...
		private static final char[] iSolarLunarOffsetTable = { 49, 38, 28, 46, 34, 24, 43, 32, 21, 40, // 1910 
			...
			33, 22, 40, 31, 50, 39, 28, 47, 35, 24, // 2020 
