...
public class CalendarACtivity extends Activity {
	...
	public void createLocalAccount() {
		Cursor cursor = this.getContentResolver().query(Calendars.CONTENT_URI,
				null, null, null, null);
	...
	private void createCalendar(Context mContext, Account account) {
		...
		v.put(CalendarContract.Calendars._ID, 123);// u can give any id there
													// and use same id any where
													// u need to create event
