...
public class DetailsContentProvider extends ContentProvider {
	...
	static{
		...
		sUriMatcher.addURI(Details.AUTHORITY, Details.ITEM_TABLE_NAME+"/#", ITEM);
		sUriMatcher.addURI(Details.AUTHORITY, Details.LIST_TABLE_NAME, LISTS);
		sUriMatcher.addURI(Details.AUTHORITY, Details.LIST_TABLE_NAME+"/#", LIST);
	}
	@Override
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case ITEMS:
			cursor= db.query(Details.ITEM_TABLE_NAME, Details.ITEM_PROJECTIONS, selection, selectionArgs,
					null, null, Details.Item.ADDED_TIME+" DESC");
			break;
		case ITEM:
			...
			cursor= db.query(Details.ITEM_TABLE_NAME, Details.ITEM_PROJECTIONS, where, selectionArgs, null, null, sortOrder);
			break;
		case LISTS:
			cursor= db.query(Details.LIST_TABLE_NAME, Details.LIST_PROJECTIONS, selection, selectionArgs, null, null, Details.List.CREATED_TIME+" DESC");
			break;
		case LIST:
			...
			cursor= db.query(Details.LIST_TABLE_NAME, Details.LIST_PROJECTIONS, list_where, selectionArgs, null, null, sortOrder);
			break;
		default:
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		switch(sUriMatcher.match(uri)){
		case ITEMS:
			count=db.delete(Details.ITEM_TABLE_NAME, selection, selectionArgs);
			break;
		case ITEM:
			...
			count=db.delete(Details.ITEM_TABLE_NAME, itemWhere, selectionArgs);
			break;
		case LISTS:
			count=db.delete(Details.LIST_TABLE_NAME, selection, selectionArgs);
			break;
		case LIST:
			...
			count=db.delete(Details.LIST_TABLE_NAME, listWhere, selectionArgs);
			break;
		default:
			throw new IllegalArgumentException("Unknown uri:"+uri.toString());
		}
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		switch(sUriMatcher.match(uri)){
		case ITEMS:
			count=db.update(Details.ITEM_TABLE_NAME, values, selection, selectionArgs);
			break;
		case ITEM:
			long itemId=ContentUris.parseId(uri);
			String itemWhere=" _id="+itemId;
			...
			count=db.update(Details.ITEM_TABLE_NAME, values, itemWhere, selectionArgs);
			break;
		case LISTS:
			count=db.update(Details.LIST_TABLE_NAME, values, selection, selectionArgs);
			break;
		case LIST:
			long listId=ContentUris.parseId(uri);
			String listWhere=" _id="+listId;
			...
			count=db.update(Details.LIST_TABLE_NAME, values, listWhere, selectionArgs);
			break;
		default:
			throw new IllegalArgumentException("Unknown uri:"+uri.toString());
		}
