...
public class DatabaseAsyncService {
	...
	void asyncQuery(final Uri uri, final String[] projection,
			final String selection, final String[] selectionArgs,
			final String sortOrder, int tag) {
		mTag = tag;
		new Thread(new Runnable() {
	...
	void asyncUpdate(final Uri uri, final ContentValues values,
			final String selection, final String[] selectionArgs, int tag) {
		mTag = tag;
		new Thread(new Runnable() {
	...
	void asyncDelete(final Uri uri, final String selection,
