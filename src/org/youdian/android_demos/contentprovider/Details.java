...
public class Details {
	...
	public static final String[] ITEM_PROJECTIONS = { Details.Item._ID,
			Details.Item.ITEM_NAME, Details.Item.ITEM_COUNT,
			Details.Item.ITEM_STATUS, Details.Item.ADDED_TIME, };

	public static final String[] LIST_PROJECTIONS = { Details.List._ID,
			Details.List.LIST_NAME, Details.List.CREATED_TIME, };

	public static final class Item implements BaseColumns {
		public static final Uri CONTENT_URI = Uri.parse("content://"
				+ AUTHORITY + "/" + ITEM_TABLE_NAME);
