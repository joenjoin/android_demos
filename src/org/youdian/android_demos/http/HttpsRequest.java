...
public class HttpsRequest {
	...
	/*
	 * 通过使用私有证书来访问https网站
	 * 公钥保存在 /assets/youdian.cer  为X509格式
	 * 未测试过
	 */
	public static InputStream viaPrivateCertificateConnection(String link,Context context){
	...
	public static InputStream viaUnsafeConnection(String url){
		try {
			...
			ctx.init(null, new TrustManager[]{new UnsafeTrustManager()}, new SecureRandom());
